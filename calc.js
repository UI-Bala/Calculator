...
let btnnumbers = createElements('button', 'btn-fluid btn-dark text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2', 10);
...
let square = createButton('x<sup>2</sup>', 'square', 'power2()')
let equals = createButton('=', '=', 'equate()');
let root = createButton('&radic;', 'root', 'sqrRoot()');
let dot = createButton('.', '.', `appendNumber('.')`);
let clear = createButton('clr', 'clr', 'clearScreen()');
let cube = createButton('x<sup>3</sup>', 'cube', 'power3()')
